...
export interface DataApi {
  getOpportunities(callback : ApiHandler<Array<Opportunity>>, configuration : CallConfiguration) : Array<Opportunity>;
...
export class SalesforceApiService {
    ...
    public getOpportunities() : Observable<Array<Opportunity>> {
      let api = getSfApiWrapper();
      let builder = this.getCallBuilder<Array<Opportunity>>();
      return builder.build(() => api.getOpportunities(builder.getResponseHandler(), DEFAULT_CONFIG));
    }
}
